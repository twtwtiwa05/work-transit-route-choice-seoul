...
membership (Cram\'er's V = 0.685). All four models converge on the same variable
importance ranking (SHAP--MNL Spearman $\rho$ = 1.0). On the practical side,
...
\input{sections/calibration_reranking}
